...
source test
{
        ...
        sql_query_pre           = SET NAMES utf8
           ...
           sql_query                               = \
                select 88888888 as id, '甲基' as synonyms, '盐酸帕罗西汀' as name \
                union all \
                select 77777777 as id, '甲a基' as synonyms, '盐酸帕罗西汀' as name
}
...
#test
    ...
    {
        source                  = test
        #path                    = /opt/molbase.inc/data_search/test
        path = /var/lib/sphinx/test1

        #docinfo                 = extern
        #mlock                   = 1
        min_word_len        = 1
        #phrase_boundary = ;   #词组边界符列表
        #phrase_boundary_step = 100 #词组边界上词位置的增量
